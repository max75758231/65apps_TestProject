...
public class EmployeeSecondSpecAdapter extends RecyclerView.Adapter<EmployeeSecondSpecAdapter.MyViewHolder> {
    ...
    public EmployeeSecondSpecAdapter(Context context, ArrayList<String> name, ArrayList<String> surname,
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (!birthday.equals("-")) {
            holder.textBirthday.setText(String.valueOf(DataHandlingAdapter.calculatingAge(birthday)));
        } else {
